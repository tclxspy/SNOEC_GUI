...
namespace SNOEC_GUI
{
    public partial class _100G_DR1_From : Form
    {
        ...
        private void _100G_DR1_From_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void _100G_DR1_FromClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
